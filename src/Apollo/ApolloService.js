...
class CommonDataManager {
 ...
 const ProfileService = new ApolloClient({
  link: new HttpLink({
...
const ClientProvider = new ApolloClient({
  link: new HttpLink({
    uri: "https://api.splendid.app/api/application/graphql",
...
const DataManager = CommonDataManager.getInstance();
export { DataManager, CommonDataManager, ProfileService, ClientProvider };
